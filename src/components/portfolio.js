                    ...
                    <div class="col-md-8">
                        <div class="jumbotron jumbotron-fluid mt-5 bg-secondary border rounded">
                            <div class="container1 border border-secondary rounded">
                                ...
                                <p class="p-2 one">
                                I am Maddula Raghu Pranav, Computer Science Student at VIT-AP uinversity, passionate to work in a competitive environment where I can showcase my
                                technical skills. </p>
                            </div>
                        </div>
                            ...
                            <div class="container1 border border-secondary rounded">
                                ...
                                <p class="p-1 one">
                                    <ul>
                                        ...
                                        <li>Watching Movies, Webseries ,Reading Mahnwa</li>
                                        <li>Programming</li>
                                    </ul>
                                </p>
                            </div>
                        ...
                        <div class="jumbotron jumbotron-fluid mt-1 bg-secondary border rounded">
                            <div class="container1 border border-secondary rounded">
                                <h3 class="p-2">Contact Me: <a href="mailto:pranavmaddula04@gmail.com">Email</a> <a href="https://www.linkedin.com/in/pranav-maddula-233772229/">LinkedIn</a> +91 8341025580</h3>
                            </div>
                        </div>
                    </div>
                </div>
